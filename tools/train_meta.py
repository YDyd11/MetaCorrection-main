...
DATA_LIST_PATH = '/data12T/ydaugust/code/domain_adaptation/MetaCorrection-main/datasets/gta5_list/train.lst'
IGNORE_LABEL = 255
INPUT_SIZE = '512,256'
DATA_DIRECTORY_TARGET = '/data12T/ydaugust/data/realworld/Cityscapes'
DATA_LIST_PATH_TARGET = '/data12T/ydaugust/code/domain_adaptation/MetaCorrection-main/datasets/cityscapes_list/pseudo_ltir_new(1).lst'  # redo √
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = '/data12T/ydaugust/code/domain_adaptation/MetaCorrection-main/snapshots/resnet101/GTA5_best.pth'
SAVE_PRED_EVERY = 1000
WEIGHT_DECAY = 0.0005
LOG_DIR = '/data12T/ydaugust/code/domain_adaptation/MetaCorrection-main/log/resnet101_adv15w'
...
def obtain_meta(source_img): # 找出source domain与target domain中相像的pixel
    ...
    seg_model.load_state_dict(torch.load('/data12T/ydaugust/code/domain_adaptation/MetaCorrection-main/snapshots/resnet101/GTA5_best.pth'))
    dis_model = FCDiscriminator(num_classes=19).cuda()
    dis_model.load_state_dict(torch.load('/data12T/ydaugust/code/domain_adaptation/MetaCorrection-main/snapshots/resnet101/GTA5_best_D2.pth'))
    seg_model.eval()
    dis_model.eval()
...
def main():
    ...
    #                         # 'layer5.conv2d_list.0.bias', 'layer5.conv2d_list.1.bias',
    #                         # 'layer5.conv2d_list.2.bias', 'layer5.conv2d_list.3.bias']
